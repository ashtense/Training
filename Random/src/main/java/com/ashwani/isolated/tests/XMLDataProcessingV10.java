...
public class XMLDataProcessingV10 {
	...
	final class DataProcessingConstants {
		...
		private static final String WES = "Workers_Effective_Stack";
		private static final String WES_SUMMARY = WES + "__Summary";
	}
	...
	private static final File xmlFile = new File("C:/Users/solanka/Desktop/PECI/Testv1.xml");
	...
	private static void sendDataToHazelCast(final String currentKey, final LinkedList<String> dataList) {
		...
		if (tempData.toString().contains(DataProcessingConstants.WES)) {
